    ...
    <div className="container py-12">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div className="col-span-2 md:col-span-1">
          <Link to="/" className="flex items-center gap-2 heading-label">
            <img
              src="/notify-logo.png"
              alt="Notify Logo"
              className="h-7 w-7 rounded-lg bg-card p-0.5"
            />
            Notify
          </Link>
          <p className="heading-description leading-relaxed">
            Notification infrastructure for modern teams. Email, SMS, and Push —
            one API.
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link
                to="/templates"
                className="heading-description hover:text-foreground"
              >
                Templates
              </Link>
            </li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="#" className="heading-description hover:text-foreground">
                Blog
              </a>
            </li>
            <li>
