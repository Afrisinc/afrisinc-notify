    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto rounded-2xl">
        ...
        <div className="space-y-2 pb-4 border-b border-border/20">
          <DialogHeader className="space-y-0">
            <div className="flex items-start gap-3">
              <div
                className={`${isDashboard ? "w-1 h-10" : "w-1 h-10"} bg-gradient-to-b from-primary via-primary to-primary/50 rounded-full mt-0.5`}
              />
              <div className="space-y-1.5 flex-1">
                ...
                <DialogDescription
                  className={`${isDashboard ? "text-sm" : "text-sm"} text-content-secondary dark:text-foreground/70`}
                >
        ...
        <div className="space-y-5">
          ...
          >
            ...
            template.image ? (
              ...
              <div className="relative z-10 h-full w-full flex flex-col items-center justify-center gap-3">
                ...
                >
                  <Sparkles
                    className={`${isDashboard ? "h-12 w-12" : "h-8 w-8"} text-primary/40 dark:text-primary/50`}
                  />
                </motion.div>
                <p
                  className={`${isDashboard ? "text-sm" : "text-xs"} text-content-secondary/60 dark:text-foreground/50 font-medium`}
                >
          ...
          {/* Preview Content */}
          <div
            className={`${isDashboard ? "bg-surface-secondary/50 dark:bg-card/50 border border-border/20 dark:border-border/40 rounded-xl p-5" : "bg-card border border-border/50 rounded-lg p-4"} space-y-4`}
          >
            ...
            {isDashboard ? (
              <>
                ...
                >
                  ...
                  <p className="text-xs font-semibold text-content-secondary dark:text-foreground/60 uppercase">
                    Community Rating
                  </p>
                </motion.div>
          ...
          {/* Action Buttons */}
          <div
            className={`flex gap-2 pt-2 border-t ${isDashboard ? "border-border/20" : "border-border/30 dark:border-border/40"}`}
          >
            <Button
              variant="outline"
              size="default"
