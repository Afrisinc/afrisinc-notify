      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-content-secondary">
            {app.description || app.environment}
          </p>
        </div>
        <span
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { label: "Templates", value: app.templateCount, icon: FileText },
              {
                ...
                value: app.notificationsSent.toLocaleString(),
                icon: Send,
              },
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                >
                  <Store className="h-3.5 w-3.5 mr-1.5" /> Import from
                  Marketplace
                </Button>
                <Button size="sm">
            ...
            {templates.length === 0 ? (
              <Card className="border-dashed border-2">
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-sm text-content-secondary">
                    No templates yet. Create one or import from the marketplace.
                  </p>
                </CardContent>
              </Card>
            ) : (
                  ...
                  <Card key={tpl.id} className="border-border/60">
                    <CardContent className="flex items-center justify-between py-3 px-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          variant="secondary"
                          className={`text-[10px] ${statusColor(tpl.status)}`}
                        >
                          {tpl.status}
                        </Badge>
