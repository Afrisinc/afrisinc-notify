...
const steps = [
  {
    ...
    description: "Design your first email or notification template.",
    done: false,
  },
  {
    icon: Key,
    title: "Generate an API key",
    description: "Get your credentials for sending via API.",
    done: false,
  },
  {
    icon: Send,
    ...
    <OnboardingLayout>
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          Complete these steps to start sending notifications.
        </p>
      </div>
