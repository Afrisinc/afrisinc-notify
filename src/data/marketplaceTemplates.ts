...
export const mockTemplates: MarketplaceTemplate[] = [
  {
    ...
    name: "Welcome Email",
    description:
      "Get new users excited. Mobile-optimized welcome with CTA buttons that actually convert.",
  ...
  },
  {
    ...
    description:
      "Turn confirmation into delight. Show order details, tracking link, and support info beautifully.",
    category: "ecommerce",
    channel: "email",
    price: 5,
    rating: 4.9,
  ...
  },
  {
    ...
    name: "Password Reset",
    description:
      "Keep accounts secure. Clean, scannable reset email with time-limited link and safety tips.",
    category: "authentication",
    channel: "email",
    price: 0,
    rating: 4.7,
    ...
    installs: 18900,
    image:
      "https://images.unsplash.com/photo-1526374965328-7f5ae4e8b69e?w=500&h=300&fit=crop",
  ...
  },
  {
    ...
    description:
      "Save failed transactions. Clear error message with one-click retry and support link.",
    category: "alerts",
    channel: "email",
    price: 0,
    rating: 4.6,
  ...
  },
  {
    ...
    description:
      "Build your audience. Multi-section newsletter template with featured stories and social links.",
    category: "marketing",
    channel: "email",
    price: 3,
    rating: 4.8,
    ...
    installs: 12400,
    image:
      "https://images.unsplash.com/photo-1587614382346-4ec2e10529d0?w=500&h=300&fit=crop",
  ...
  },
  {
    ...
    description:
      "Secure 2FA code delivery with clear instructions and security tips.",
    category: "authentication",
    channel: "sms",
    price: 0,
    rating: 4.9,
    ...
    installs: 22100,
    image:
      "https://images.unsplash.com/photo-1516534775068-bb57e39c8ac4?w=500&h=300&fit=crop",
  ...
  },
  {
    ...
    description:
      "Appointment reminder with date, time, location, and rescheduling options.",
    ...
    preview: {
      ...
      content:
        "Your appointment with {{doctorName}} is on {{date}} at {{time}}",
    },
    features: [
      "Time formatting",
      "Reschedule link",
  ...
  },
  {
    ...
    description:
      "Boost sales. Eye-catching design with discount codes, timer, and product showcase.",
    category: "marketing",
    channel: "email",
    price: 4,
    rating: 4.5,
  ...
  },
  {
    ...
    description:
      "Manage renewals gracefully. Show next date, benefits, and easy plan management options.",
    category: "transactional",
    channel: "email",
    price: 0,
    rating: 4.8,
  ...
  },
  {
    ...
    description:
      "Critical system alert for service downtime with incident status and updates.",
    category: "alerts",
    channel: "email",
    price: 0,
    rating: 4.6,
  ...
  },
  {
    ...
    description:
      "Concise SMS marketing message with short codes and click-through tracking.",
    category: "marketing",
    channel: "sms",
    price: 3,
    rating: 4.7,
    ...
    installs: 7100,
    image:
      "https://images.unsplash.com/photo-1611092583519-681366b3f78f?w=500&h=300&fit=crop",
  ...
  },
  {
    ...
    description:
      "Time-sensitive push notification for flash sales with deep link to products.",
    category: "marketing",
    channel: "push",
    price: 2,
    rating: 4.6,
    ...
    preview: {
      ...
      content:
        "🔥 {{discountPercent}}% off {{productName}} - Ends in {{timeLeft}}",
    },
